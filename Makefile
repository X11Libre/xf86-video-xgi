...
# platform:  $XFree86: xc/config/cf/linux.cf,v 3.201 2003/02/17 17:07:32 dawes Exp $

# operating system:  Linux 2.6.11.11 ppc [ELF] (2.6.11)
# libc:	(6.3.2)
# binutils:	(215)
...
TCLIBDIR = /usr/lib
          ...
          PATHSEP = /
            SHELL = /bin/sh -e
              ...
              TOP = ../../../../../..
      CURRENT_DIR = programs/Xserver/hw/xfree86/drivers/xgi
...
CXXDEPENDINCLUDES =
 CXXEXTRA_DEFINES =
CXXEXTRA_INCLUDES =
   CXXSTD_DEFINES = -Dlinux -D__powerpc__ -D_POSIX_C_SOURCE=199309L 				-D_POSIX_SOURCE -D_XOPEN_SOURCE 				-D_BSD_SOURCE -D_SVID_SOURCE 				 -D_GNU_SOURCE 				 $(CXXPROJECT_DEFINES)
       CXXOPTIONS =
...
MODLDCOMBINEFLAGS = -r
  ...
  STD_CPP_DEFINES = -traditional -Dlinux -D__powerpc__ -D_POSIX_C_SOURCE=199309L 				-D_POSIX_SOURCE -D_XOPEN_SOURCE 				-D_BSD_SOURCE -D_SVID_SOURCE 				 -D_GNU_SOURCE 				 $(PROJECT_DEFINES)
      STD_DEFINES = -Dlinux -D__powerpc__ -D_POSIX_C_SOURCE=199309L 				-D_POSIX_SOURCE -D_XOPEN_SOURCE 				-D_BSD_SOURCE -D_SVID_SOURCE 				 -D_GNU_SOURCE 				 $(PROJECT_DEFINES)
...
# X Window System make variables; these need to be coordinated with rules
  ...
  PROXYMANAGERDIR = $(LIBDIR)/proxymngr
     ...
     INSTAPPFLAGS = $(INSTDATFLAGS)
      ...
      MKHTMLINDEX = $(PERL) $(PERLOPTS) $(CONFIGSRC)/util/mkhtmlindex.pl
...
DEPXFONTENCLIB = $(TOP)/exports/lib/libfontenc.a
...
# $XFree86: xc/programs/Xserver/hw/xfree86/drivers/xgi/Imakefile,v 1.33 2003/08/29 08:50:54 twini Exp $
#
# This is an Imakefile for the XGI driver.
#
...
STD_DEFINES = -Dlinux -D__powerpc__ -D_POSIX_C_SOURCE=199309L 				-D_POSIX_SOURCE -D_XOPEN_SOURCE 				-D_BSD_SOURCE -D_SVID_SOURCE 				 -D_GNU_SOURCE 				 -DSHAPE -DXINPUT -DXKB -DLBX -DXAPPGROUP 	-DXCSECURITY -DTOGCUP  	-DXF86BIGFONT -DDPMSExtension 	 -DPIXPRIV -DPANORAMIX 	 -DRENDER -DRANDR -DGCCUSESGAS -DAVOID_GLYPHBLT -DPIXPRIV -DSINGLEDEPTH 				-DXFreeXDGA -DXvExtension 				-DXFree86LOADER  -DXFree86Server 				-DXF86VIDMODE 				-DXvMCExtension 				 				-DSMART_SCHEDULE 				-DBUILDDEBUG -DXResExtension 				-DX_BYTE_ORDER=X_BIG_ENDIAN -DNDEBUG $(SERVER_THREAD_DEFINES)
CDEBUGFLAGS = -O2 -fno-strict-aliasing
EXT_DEFINES =  -DMITMISC -DXTEST -DXTRAP 	-DXSYNC -DXCMISC -DXRECORD 	 -DMITSHM  -DBIGREQS -DXF86VIDMODE 	-DXF86MISC -DDBE -DDPMSExtension -DEVI 	-DSCREENSAVER -DXV -DXVMC 	-DGLXEXT -DXF86DRI -DGLX_DIRECT_RENDERING -DGLX_USE_DLOPEN -DGLX_USE_MESA  -DFONTCACHE          -DRES
...
DRISRCS = xgi_dri.c
DRIOBJS = xgi_dri.o
DRIINCLUDES = -I$(SERVERSRC)/GL/dri -I$(LIBSRC)/GL/dri               -I$(XF86OSSRC)/shared/drm/kernel               -I$(XTOP)/include

DRIDEFINES = $(GLX_DEFINES)

SRCS = vb_ext.c vb_init.c vb_setmode.c vb_util.c       xgi_driver.c xgi_dac.c xgi_cursor.c xgi_accel.c xgi_setup.c       xgi_vga.c xgi_vb.c       xgi_opt.c xgi_dga.c init.c        xgi_video.c xgi_videohw.c  	   $(DRISRCS)

OBJS = vb_ext.o vb_init.o vb_setmode.o vb_util.o       xgi_driver.o xgi_dac.o xgi_cursor.o xgi_accel.o xgi_setup.o       xgi_vga.o xgi_vb.o       xgi_opt.o xgi_dga.o init.o        xgi_video.o xgi_videohw.o 	   $(DRIOBJS)

INCLUDES = -I. -I$(XF86COMSRC) -I$(XF86OSSRC) -I$(SERVERSRC)/Xext            -I$(SERVERSRC)/mfb -I$(SERVERSRC)/mi            -I$(SERVERSRC)/fb -I$(XF86SRC)/xaa            -I$(XF86SRC)/xf1bpp -I$(XF86SRC)/xf4bpp            -I$(XF86SRC)/xf24_32bpp            -I$(XF86SRC)/vgahw -I$(XF86SRC)/ramdac            -I$(XF86SRC)/ddc -I$(XF86SRC)/i2c -I$(XF86SRC)/vbe            -I$(XF86SRC)/rac -I$(XF86SRC)/int10            -I$(FONTINCSRC) -I$(SERVERSRC)/include -I$(XINCLUDESRC)            -I$(XTOP)/include/extensions 		   -I$(SERVERSRC)/render 		   -I$(XF86SRC)/shadowfb            $(DRIINCLUDES)
...
xgi_drv.o:  $(OBJS) $(EXTRALIBRARYDEPS)
	$(RM) $@
...
all:: xgi_drv.o
	...
	$(RM) $(BUILDMODULEDIR)/drivers/xgi_drv.o
	@(UP="`$(REVPATH) drivers`"; set -x; \
	  cd $(BUILDMODULEDIR)/drivers && \
		$(LN) $(BUILDMODULETOP)/$${UP}$(CURRENT_DIR)/xgi_drv.o .)
...
install:: xgi_drv.o
	...
	$(INSTALL) -c $(INSTDATFLAGS) xgi_drv.o $(DESTDIR)$(MODULEDIR)/drivers

all:: xgi.$(DRIVERMANSUFFIX).html

xgi.$(DRIVERMANSUFFIX).html: xgi.$(MANNEWSUFFIX) $(RMAN)
	$(RM) xgi.$(DRIVERMANSUFFIX).html xgi.$(DRIVERMANSUFFIX)-html
	$(RMAN) $(RMANOPTIONS) < xgi.$(MANNEWSUFFIX) \
	  > xgi.$(DRIVERMANSUFFIX)-html && $(MV) xgi.$(DRIVERMANSUFFIX)-html $@

install.man:: xgi.$(DRIVERMANSUFFIX).html
	...
	@(SUF=`expr $(DRIVERMANSUFFIX) \: '\(.\)'`; \
	 set -x; \
	 $(INSTALL) $(INSTALLFLAGS) $(INSTMANFLAGS) xgi.$(DRIVERMANSUFFIX).html $(DESTDIR)$(DOCHTMLDIR)/xgi.$$SUF.html)

cleandir::
	$(RM) xgi.$(DRIVERMANSUFFIX).html xgi.$(DRIVERMANSUFFIX)-html

all:: xgi.$(MANNEWSUFFIX)

xgi.$(MANNEWSUFFIX)::  xgi.$(MANSRCSUFFIX)
	$(RM) $@
	 	$(RAWCPP)  $(MANDEFS)  $(EXTRAMANDEFS) <xgi.$(MANSRCSUFFIX) | sed -e '/^#  *[0-9][0-9]*  *.*$$/d' -e '/^XCOMM$$/s//#/' -e '/^XCOMM[^a-zA-Z0-9_]/s/^XCOMM/#/' >$@

cleandir::
	$(RM) xgi.$(MANNEWSUFFIX)

install.man:: xgi.$(MANNEWSUFFIX)
	...
	$(INSTALL) -c $(INSTMANFLAGS) xgi.$(MANNEWSUFFIX) \
		$(DESTDIR)$(DRIVERMANDIR)/xgi.$(DRIVERMANSUFFIX)
...
install.sdk:: Imakefile
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
			(set -x; rm -f $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi); \
		fi; \
		(set -x; $(MKDIRHIER) $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi); \
	fi
	$(INSTALL) -c $(INSTDATFLAGS) Imakefile $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi
...
install.sdk:: xgi.h
	...
	$(INSTALL) -c $(INSTDATFLAGS) xgi.h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: xgi_accel.h
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) xgi_accel.h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: xgi_accel.c
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) xgi_accel.c $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi
...
install.sdk:: init.c
	...
	$(INSTALL) -c $(INSTDATFLAGS) init.c $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi
...
install.sdk:: init.h
	...
	$(INSTALL) -c $(INSTDATFLAGS) init.h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi
...
install.sdk:: osdef.h
	...
	$(INSTALL) -c $(INSTDATFLAGS) osdef.h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: initdef.h
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) initdef.h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: xgi_cursor.c
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) xgi_cursor.c $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: xgi_cursor.h
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) xgi_cursor.h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: xgi_dac.c
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) xgi_dac.c $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: xgi_dac.h
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) xgi_dac.h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: xgi_dga.c
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) xgi_dga.c $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: xgi_dri.c
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) xgi_dri.c $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: xgi_dri.h
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) xgi_dri.h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: xgi_common.h
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) xgi_common.h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: xgi_driver.c
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) xgi_driver.c $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: xgi_video.c
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) xgi_video.c $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: xgi_video.h
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) xgi_video.h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: xgi_videohw.c
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) xgi_videohw.c $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: xgi_videohw.h
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) xgi_videohw.h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: xgi_vidregs.h
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) xgi_vidregs.h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: xgi_driver.h
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) xgi_driver.h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: xgi_opt.c
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) xgi_opt.c $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi
...
install.sdk:: regs.h
	...
	$(INSTALL) -c $(INSTDATFLAGS) regs.h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: xgi_setup.c
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) xgi_setup.c $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: xgi_vb.c
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) xgi_vb.c $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: xgi_vb.h
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) xgi_vb.h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: xgi_vga.c
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) xgi_vga.c $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi
...
install.sdk:: vgatypes.h
	...
	$(INSTALL) -c $(INSTDATFLAGS) vgatypes.h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: xgi_ver.h
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) xgi_ver.h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: vb_struct.h
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) vb_struct.h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: vb_def.h
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) vb_def.h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: vb_ext.c
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) vb_ext.c $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: vb_init.c
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) vb_init.c $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: vb_setmode.c
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) vb_setmode.c $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: vb_util.c
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) vb_util.c $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: vb_ext.h
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) vb_ext.h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: vb_init.h
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) vb_init.h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: vb_setmode.h
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) vb_setmode.h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: vb_util.h
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) vb_util.h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi
...
install.sdk:: vb_table.h
	...
	$(INSTALL) -c $(INSTDATFLAGS) vb_table.h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: xgi_pci.h
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) xgi_pci.h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: xgi_regs.h
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) xgi_regs.h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: valid_mode.h
	@if [ -d $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi ]; then \
	...
	$(INSTALL) -c $(INSTDATFLAGS) valid_mode.h $(DESTDIR)$(DRIVERSDKDIR)/drivers/xgi

install.sdk:: xgi_drv.o
	@if [ -d $(DESTDIR)$(DRIVERSDKMODULEDIR)/drivers ]; then \
		set +x; \
	else \
		if [ -h $(DESTDIR)$(DRIVERSDKMODULEDIR)/drivers ]; then \
			(set -x; rm -f $(DESTDIR)$(DRIVERSDKMODULEDIR)/drivers); \
		fi; \
		(set -x; $(MKDIRHIER) $(DESTDIR)$(DRIVERSDKMODULEDIR)/drivers); \
	fi
	$(INSTALL) -c xgi_drv.o $(DESTDIR)$(DRIVERSDKMODULEDIR)/drivers
