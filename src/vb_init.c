...
/* Description : */
/* --------------------------------------------------------------------- */
void XGINew_DDR1x_MRS_340( PXGI_HW_DEVICE_INFO HwDeviceExtension , USHORT P3c4 , PVB_DEVICE_INFO pVBInfo)
{
    ...
    if (HwDeviceExtension->jChipType == XG45)
    XGINew_SetReg1( P3c4 , 0x19 , 0x01 ) ;				/*TSop DRAM DLL pin jump to A9*/
    else
    XGINew_SetReg1( P3c4 , 0x19 , 0x02 ) ;				/*TSop DRAM DLL pin jump to A9*/
...
/* Description : */
/* --------------------------------------------------------------------- */
void XGINew_DDR2x_MRS_340( PXGI_HW_DEVICE_INFO HwDeviceExtension , USHORT P3c4 , PVB_DEVICE_INFO pVBInfo)
{
    XGINew_SetReg1( P3c4 , 0x18 , 0x00 ) ;
    if ( HwDeviceExtension->jChipType == XG42 )		/*XG42 BA0 & BA1  layout change*/
        XGINew_SetReg1( P3c4 , 0x19 , 0x40 ) ;
...
/* Description : */
/* --------------------------------------------------------------------- */
void XGINew_DDR2_MRS_340( PXGI_HW_DEVICE_INFO HwDeviceExtension ,  USHORT P3c4 , PVB_DEVICE_INFO pVBInfo)
{
...
void XGINew_SetDRAMDefaultRegisterXG45( PXGI_HW_DEVICE_INFO HwDeviceExtension ,  USHORT Port , PVB_DEVICE_INFO pVBInfo)
{
    ...
    XGINew_SetReg1( P3d4 , 0x6D , pVBInfo->CR40[ 8 ][ XGINew_RAMType ] ) ;
    XGINew_SetReg1( P3d4 , 0x6E , pVBInfo->XG45CR6E[ XGINew_RAMType ] ) ;
    XGINew_SetReg1( P3d4 , 0x6F , pVBInfo->XG45CR6F[ XGINew_RAMType ] ) ;
    XGINew_SetReg1( P3d4 , 0x68 , pVBInfo->CR40[ 5 ][ XGINew_RAMType ] ) ;
    XGINew_SetReg1( P3d4 , 0x69 , pVBInfo->CR40[ 6 ][ XGINew_RAMType ] ) ;
    XGINew_SetReg1( P3d4 , 0x6A , pVBInfo->CR40[ 7 ][ XGINew_RAMType ] ) ;
    ...
    {            
        ...
        for ( i = 0 ; i < 3 ; i ++ )
        {
            ...
            for ( j = 0 ; j < 32 ; j ++ )
                XGINew_SetReg1( P3d4 , 0x44 , j * 0x08 );
        }    
    }
    
    for ( j = 0 ; j < 3 ; j ++ )            
    	XGINew_SetReg1( P3d4 , 0x45 , j * 0x08 ) ;	/* CR45 */
    
    XGINew_SetReg1( P3d4 , 0x97 , 0x84 ) ;
    XGINew_SetReg1( P3d4 , 0x98 , 0x01 ) ;
    XGINew_SetReg1( P3d4 , 0x99 , 0x22 ) ;
    XGINew_SetReg1( P3d4 , 0x9A , 0x02 ) ;
    ...
    XGINew_SetReg1( P3d4 , 0xC8 , 0x04 ) ;
    
    for( j = 0 ; j < 2 ; j++ )
        XGINew_SetReg1( P3d4 , ( 0x8A + j ) , pVBInfo->CR40[ 1 + j ][ XGINew_RAMType ] ) ;	/* CR8A - CR8B */

    XGINew_SetReg1( P3d4 , 0x8C , 0x40 ) ;
    ...
    XGINew_SetReg1( P3d4 , 0x83 , 0x09 ) ;	/* CR83 */
    XGINew_SetReg1( P3d4 , 0x87 , 0x00 ) ;	/* CR87 */
    XGINew_SetReg1( P3d4 , 0x8D , 0x87 ) ;	/* CR8D */
...
/*--------------------------------------------------------------------- */
int XGI45New_ReadWriteRest( USHORT StopAddr , USHORT StartAddr, PVB_DEVICE_INFO pVBInfo)
{
    int i ;
    ULONG Position = 0 ;
...
*/
      ...
      case XG45: 
           ...
           XGINew_SetReg1( pVBInfo->P3c4 , 0x13 , 0xA1 ) ;
           XGINew_SetReg1( pVBInfo->P3c4 , 0x14 , 0x58 ) ;
           ...
           XGINew_ChannelAB = 2 ;		/* 2 Channel */
           XGINew_SetReg1( pVBInfo->P3c4 , 0x13 , 0xA1 ) ;
           XGINew_SetReg1( pVBInfo->P3c4 , 0x14 , 0x54 ) ;
           ...
           {
               XGINew_SetReg1( pVBInfo->P3c4 , 0x13 , 0xA1 ) ;
               XGINew_SetReg1( pVBInfo->P3c4 , 0x14 , 0x50+i ) ;
